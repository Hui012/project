...
public class ProductCmtVO implements Serializable{
	...
	private Integer product_Cmt_Grade;
	...
	public Integer getProduct_Cmt_Grade() {
		return product_Cmt_Grade;
	}
	public void setProduct_Cmt_Grade(Integer product_Cmt_Grade) {
	...
	public String toString() {
		return "ProductCmtVO [product_Cmt_ID=" + product_Cmt_ID + ", product_ID=" + product_ID + ", member_ID="
				...
				+ ", product_Cmt_Img1=" + Arrays.toString(product_Cmt_Img1) + ", product_Cmt_Img2="
				+ Arrays.toString(product_Cmt_Img2) + ", product_Cmt_Timestamp=" + product_Cmt_Timestamp + "]";
	}
	@Override
	public int hashCode() {
		final int prime = 31;
