...
public class Order_MasterService {
	...
	public Set<Order_MasterVO> getOrderMasterByMemberID(String member_ID){
		return dao.selecyByMember(member_ID);
	}
	
	public Order_MasterVO addOrder_Master(String order_Master_ID, String member_ID, String coupon_ID, String order_Master_Payment, java.sql.Timestamp order_Master_TimeStamp, Integer order_Master_State) {
...
//		dao.addOrder_Master(null, "MID000000", "CNID000000", "信用卡", null, 1);
