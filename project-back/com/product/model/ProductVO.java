...
public class ProductVO implements Serializable{
	...
	public String toString() {
		return "ProductVO [product_ID=" + product_ID + ", product_Name=" + product_Name + ", product_Intro="
				...
				+ ", product_Img1=" + Arrays.toString(product_Img1) + ", product_Img2=" + Arrays.toString(product_Img2)
				+ ", product_Img3=" + Arrays.toString(product_Img3) + ", product_Img4=" + Arrays.toString(product_Img4)
				+ ", product_Img5=" + Arrays.toString(product_Img5) + "]";
	}
	@Override
	public int hashCode() {
		final int prime = 31;
